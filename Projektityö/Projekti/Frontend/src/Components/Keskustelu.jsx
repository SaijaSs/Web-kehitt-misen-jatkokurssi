...
const Keskustelu = () => {
    ...
    useEffect(() => {
        const haeKeskustelu = async () => {
            try {
                const res = await fetch(`https://projekti-backend-ezg5g3cwengphuby.centralus-01.azurewebsites.net/threads/${id}`);
        ...
        const haeKommentit = async () => {
            try {
                const res2 = await fetch(`https://projekti-backend-ezg5g3cwengphuby.centralus-01.azurewebsites.net/threads/${id}/comments`);
